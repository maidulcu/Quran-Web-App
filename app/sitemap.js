const BASE_URL = 'https://quran.learntrueislam.com';
...
export default function sitemap() {
  ...
  const staticPages = [
    ...
    { url: `${BASE_URL}/surahs`, lastModified: now, changeFrequency: 'weekly', priority: 0.9 },
    { url: `${BASE_URL}/search`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${BASE_URL}/progress`, lastModified: now, changeFrequency: 'monthly', priority: 0.6 },
  ];

  const surahPages = Object.entries(SURAH_NAMES).map(([id, name]) => ({

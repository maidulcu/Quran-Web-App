...
export async function generateMetadata({ params }) {
  ...
  const description = info.summary
    ...
    : `Read and listen to Surah ${name} (${translation}) — Arabic text with Sahih International English translation and audio recitation. Full chapter with all ${AYAH_COUNTS[id] || ''} verses.`;
